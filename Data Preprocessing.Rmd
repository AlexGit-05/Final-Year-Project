---
title: "Data Preprocessing and  Pre Analysis"
output:
  html_document:
    df_print: paged
---
...
# Importing files while processing them
Import.Data1=function(list.of.dataframe,number.of.dataframe){
  ...
  for(i in number.of.dataframe){
    ...
    x[,"value"]=apply(x[,"value"],2,as.numeric) # convert the variable value to numeric
    x=x %>% 
...
```{r importing data}
#Importing csv files and saving them in form of a list 
